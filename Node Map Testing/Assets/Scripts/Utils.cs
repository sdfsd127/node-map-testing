...
namespace CM_Utilities
{
    public static class Utils
    {
        ...
        public static void PrintArraySize<T>(T[] array, string desc = "NULL")
        {
            if (desc != "NULL")
                Debug.Log(desc + " : " + array.Length);
            else
                Debug.Log(array.Length);
        }

        public static void PrintListSize<T>(List<T> list, string desc = "NULL")
        {
            if (desc != "NULL")
                Debug.Log(desc + " : " + list.Count);
            else
